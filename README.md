...
1. **Start-Up Response:** Thanks to the 100nF Soft-Start capacitor, the system reaches a stable 12V within 7 ms without any overshoot.
   *(See: /Measurements/Startup_Graph.png)* <img width="1916" height="899" alt="image" src="https://github.com/user-attachments/assets/9239985d-b478-438b-92ad-2aa4ccca5e51" />
...
2. **Load Transient Response:** During sudden load steps from 0.5A to 5A (10% -> 100%), voltage fluctuation is limited to 2.2% (254mV), and the controller restores regulation within 150 µs.
   *(See: /Measurements/Transient_Graph.png)* <img width="1916" height="899" alt="image" src="https://github.com/user-attachments/assets/22290ce3-c2a8-45b3-91d0-627af600b1b7" />
   


4. **Voltage Ripple:** With 500 kHz switching and a low-ESR ceramic hybrid capacitor array, the output ripple at full load (5A) is reduced to **<10mV**.
